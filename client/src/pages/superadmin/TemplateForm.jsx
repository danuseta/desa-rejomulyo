  ...
  const handleFileSelect = async (event) => {
    ...
    try {
      ...
      if (container) {
        ...
        // Create wrapper div
        const docxPreviewWrapper = document.createElement('div');
        docxPreviewWrapper.className = 'docx-wrapper';
        container.appendChild(docxPreviewWrapper);
  
        await renderAsync(arrayBuffer, docxPreviewWrapper);
      }
    } catch (error) {
        ...
        <div className="flex items-center gap-3">
          ...
          <div>
            ...
            <p className="text-sm text-gray-500 mt-0.5">
              {id ? 'Perbarui template surat' : 'Buat template surat baru'}
            </p>
          </div>
        </div>
      </div>
          ...
          {templateFile && (
            <div>
              ...
              <div 
                ...
                className="border rounded-lg p-4 bg-gray-50 min-h-[500px] max-h-[800px] overflow-auto"
              >
